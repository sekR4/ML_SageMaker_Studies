...
def _get_train_loader(batch_size, data_dir):
    ...
    train_data = pd.read_csv(
        os.path.join(data_dir, "train.csv"), header=None, names=None
    )
...
if __name__ == "__main__":
    ...
    # Model parameters
    parser.add_argument("--input_dim", type=int, default=10, metavar="indim")
    parser.add_argument("--hidden_dim", type=int, default=10, metavar="hiddim")
    parser.add_argument("--output_dim", type=int, default=1, metavar="outdim")
